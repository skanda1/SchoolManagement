...
public class TeacherViewTaskList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_view_task_list);
        ...
        viewstudents.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                adapter =new ArrayAdapter<String>(TeacherViewTaskList.this,R.layout.layout,R.id.textView32,student);
        ...
        ls.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ob.commit();
                Toast.makeText(TeacherViewTaskList.this, ""+my.getString("name",""), Toast.LENGTH_SHORT).show();

                Intent intent=new Intent(TeacherViewTaskList.this,ViewTask.class);
